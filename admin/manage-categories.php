...
<section class="dashboard">
        ...
        <?php elseif(isset($_SESSION['edit-category-success'])) : //shows if add category was succesful ?>
        <div class="alert__message success container">
            <p>
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                ...
                <li><a href="manage-categories.php" class="active"><i class="uil uil-edit"></i>
